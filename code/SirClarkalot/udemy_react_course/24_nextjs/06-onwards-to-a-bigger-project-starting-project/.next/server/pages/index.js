...
async function getStaticProps() {
  // fetch data from an API
  const client = await external_mongodb_.MongoClient.connect("mongodb+srv://seanypee24:GK8z887DHVLXOXsZ@cluster0.ue1zp66.mongodb.net/?retryWrites=true&w=majority");
  const db = client.db();
