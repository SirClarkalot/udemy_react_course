...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://seanypee24:UgKezCSsRGLGcRuk@cluster0.idkghhp.mongodb.net/?retryWrites=true&w=majority");
  const db = client.db();
