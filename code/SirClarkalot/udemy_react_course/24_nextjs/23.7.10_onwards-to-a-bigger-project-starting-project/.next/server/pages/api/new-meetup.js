...
async function handler(req, res) {
  if (req.method === "POST") {
    ...
    const client = await mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"].connect("mongodb+srv://seanypee24:UgKezCSsRGLGcRuk@cluster0.idkghhp.mongodb.net/?retryWrites=true&w=majority");
    const db = client.db();
